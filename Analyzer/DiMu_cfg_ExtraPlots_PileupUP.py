...
process.ggh = cms.EDAnalyzer("DiMu_ExtraPlots",
   ...
   PileupFileName = cms.string('/afs/cern.ch/work/k/ktos/public/CMSSW_8_0_17/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/FILE_TESTS/PileupWeights_72660.root'),
