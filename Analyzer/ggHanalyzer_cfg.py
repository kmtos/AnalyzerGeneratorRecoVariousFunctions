...
process.ggh = cms.EDAnalyzer("GGHAnalyzer",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/NMSSM_Analysis/CMSSW_7_4_12_patch4/src/BBA/Analyzer/DIRNAME/DIRNAME.root'),
...
process.recoTauSelector = cms.EDFilter('CleanJetRefSelector',
...
process.genATauMuMatchedRecoTauSelector = cms.EDFilter(
    ...
    recoObjTag = cms.InputTag('recoTauSelector'),              #must be a reco::MuonRefVector
