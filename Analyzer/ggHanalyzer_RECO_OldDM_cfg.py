...
mylist = FileUtils.loadListFromFile('/afs/cern.ch/user/k/ktos/GroupDir/CMSSW_8_0_6/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/FILE_TESTS/inFileList_ggH750_a9_CleanJets.txt')
...
process.ggh = cms.EDAnalyzer("GGHAnalyzer_IndivRECO",
   ...
   isoPtSumTagRECO = cms.InputTag("hpsPFTauDiscriminationByRawCombinedIsolationDBSumPtCorr", "", "RECO"),
