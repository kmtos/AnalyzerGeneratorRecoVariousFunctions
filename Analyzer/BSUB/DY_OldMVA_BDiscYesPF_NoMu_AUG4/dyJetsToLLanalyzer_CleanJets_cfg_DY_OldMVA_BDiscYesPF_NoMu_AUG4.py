...
process.ggh = cms.EDAnalyzer("FakeRateAnalyzer",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/GroupDir/CMSSW_7_6_3/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/BSUB/DY_OldMVA_BDiscYesPF_NoMu_AUG4/DY_OldMVA_BDiscYesPF_NoMu_AUG4_Plots.root'),
