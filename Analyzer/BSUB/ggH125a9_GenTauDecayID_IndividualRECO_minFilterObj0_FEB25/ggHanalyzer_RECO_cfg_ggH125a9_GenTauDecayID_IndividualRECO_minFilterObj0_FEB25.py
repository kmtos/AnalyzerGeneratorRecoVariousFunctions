...
process.ggh = cms.EDAnalyzer("GGHAnalyzer_IndivRECO",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/GroupDir/CMSSW_7_4_12_patch4/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/BSUB/ggH125a9_GenTauDecayID_IndividualRECO_minFilterObj0_FEB25/ggH125a9_GenTauDecayID_IndividualRECO_minFilterObj0_FEB25_Plots.root'),
...
process.genATauMuMatchedRecoTauSelectorRECO = cms.EDFilter(
    ...
    dR = cms.double(0.1),                 #dR criteria for matching
    ifTauColl = cms.bool(True),           #This Creates a map of GenTaus and their Decay Mode and Visible Pt
    minNumGenObjectsToPassFilter = cms.uint32() #EDFilter returns true if >=1 gen-matched reco muon is found
    )
