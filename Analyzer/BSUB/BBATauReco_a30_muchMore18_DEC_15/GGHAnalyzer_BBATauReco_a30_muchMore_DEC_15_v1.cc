...
void GGHAnalyzer::beginJob()
{
  ...
  MatchedLooseIsoRECOPt_  = new TH1F("MatchedLooseIsoRECOPt"    , "", 18, 0, 90.0);
  MatchedMedIsoRECOPt_    = new TH1F("MatchedMedIsoRECOPt", "", 18, 0, 90);
  MatchedTightIsoRECOPt_    = new TH1F("MatchedTightIsoRECOPt", "", 18, 0, 90);
  MatchedDMFindRECOPt_    = new TH1F("MatchedDMFindRECOPt"    , "", 18, 0, 90);
  MatchedRECOPt_          = new TH1F("MatchedRECOPt"    , "", 18, 0, 90);

  MatchedLooseIsoCJPt_  = new TH1F("MatchedLooseIsoCJPt"    , "", 18, 0, 90.0);
  MatchedMedIsoCJPt_    = new TH1F("MatchedMedIsoCJPt", "", 18, 0, 90);
  MatchedTightIsoCJPt_    = new TH1F("MatchedTightIsoCJPt", "", 18, 0, 90);
  MatchedDMFindCJPt_    = new TH1F("MatchedDMFindCJPt"    , "", 18, 0, 90);
  MatchedCJPt_          = new TH1F("MatchedCJPt"    , "", 18, 0, 90);
  ...
  MatchedLooseIsoRECOdR_  = new TH1F("MatchedLooseIsoRECOdR"    , "", 18, 0, 4.0);
  MatchedMedIsoRECOdR_    = new TH1F("MatchedMedIsoRECOdR", "", 18, 0, 4);
  MatchedTightIsoRECOdR_    = new TH1F("MatchedTightIsoRECOdR", "", 18, 0, 4);
  MatchedDMFindRECOdR_    = new TH1F("MatchedDMFindRECOdR"    , "", 18, 0, 4);
  MatchedRECOdR_          = new TH1F("MatchedRECOdR"    , "", 18, 0, 4);

  MatchedLooseIsoCJdR_  = new TH1F("MatchedLooseIsoCJdR"    , "", 18, 0, 4.0);
  MatchedMedIsoCJdR_    = new TH1F("MatchedMedIsoCJdR", "", 18, 0, 4);
  MatchedTightIsoCJdR_    = new TH1F("MatchedTightIsoCJdR", "", 18, 0, 4);
  MatchedDMFindCJdR_    = new TH1F("MatchedDMFindCJdR"    , "", 18, 0, 4);
  MatchedCJdR_          = new TH1F("MatchedCJdR"    , "", 18, 0, 4);
  ...
  MatchedLooseIsoRECOPtGen_  = new TH1F("MatchedLooseIsoRECOPtGen"    , "", 18, 0, 90.0);
  MatchedMedIsoRECOPtGen_    = new TH1F("MatchedMedIsoRECOPtGen", "", 18, 0, 90);
  MatchedTightIsoRECOPtGen_    = new TH1F("MatchedTightIsoRECOPtGen", "", 18, 0, 90);
  MatchedDMFindRECOPtGen_    = new TH1F("MatchedDMFindRECOPtGen"    , "", 18, 0, 90);
  MatchedRECOPtGen_          = new TH1F("MatchedRECOPtGen"    , "", 18, 0, 90);

  MatchedLooseIsoCJPtGen_  = new TH1F("MatchedLooseIsoCJPtGen"    , "", 18, 0, 90.0);
  MatchedMedIsoCJPtGen_    = new TH1F("MatchedMedIsoCJPtGen", "", 18, 0, 90);
  MatchedTightIsoCJPtGen_    = new TH1F("MatchedTightIsoCJPtGen", "", 18, 0, 90);
  MatchedDMFindCJPtGen_    = new TH1F("MatchedDMFindCJPtGen"    , "", 18, 0, 90);
  MatchedCJPtGen_          = new TH1F("MatchedCJPtGen"    , "", 18, 0, 90);
