...
void GGHAnalyzer::beginJob()
{
  ...
  MatchedLooseIsoRECOdR_  = new TH1F("MatchedLooseIsoRECOdR"    , "", 10, 0, 4.0);
  MatchedMedIsoRECOdR_    = new TH1F("MatchedMedIsoRECOdR", "", 10, 0, 4);
  MatchedTightIsoRECOdR_    = new TH1F("MatchedTightIsoRECOdR", "", 10, 0, 4);
  MatchedDMFindRECOdR_    = new TH1F("MatchedDMFindRECOdR"    , "", 10, 0, 4);
  MatchedRECOdR_          = new TH1F("MatchedRECOdR"    , "", 10, 0, 4);

  MatchedLooseIsoCJdR_  = new TH1F("MatchedLooseIsoCJdR"    , "", 10, 0, 4.0);
  MatchedMedIsoCJdR_    = new TH1F("MatchedMedIsoCJdR", "", 10, 0, 4);
  MatchedTightIsoCJdR_    = new TH1F("MatchedTightIsoCJdR", "", 10, 0, 4);
  MatchedDMFindCJdR_    = new TH1F("MatchedDMFindCJdR"    , "", 10, 0, 4);
  MatchedCJdR_          = new TH1F("MatchedCJdR"    , "", 10, 0, 4);
