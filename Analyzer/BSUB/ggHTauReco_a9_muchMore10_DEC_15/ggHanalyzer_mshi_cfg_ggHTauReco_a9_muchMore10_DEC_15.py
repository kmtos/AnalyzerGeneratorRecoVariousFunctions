...
process.ggh = cms.EDAnalyzer("GGHAnalyzer",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/NMSSM_Analysis/CMSSW_7_4_12_patch4/src/BBA/Analyzer/BSUB/ggHTauReco_a9_muchMore10_DEC_15/ggHTauReco_a9_muchMore10_DEC_15.root'),
