...
process.ggh = cms.EDAnalyzer("FakeRateAnalyzer",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/GroupDir/CMSSW_7_6_3/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/BSUB/WJ_OldMVA_BDiscYesPF_NoMu_AUG4/WJ_OldMVA_BDiscYesPF_NoMu_AUG4_Plots.root'),
