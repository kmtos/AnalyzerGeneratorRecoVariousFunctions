...
process.ggh = cms.EDAnalyzer("GGHAnalyzer_IndivCJ",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/GroupDir/CMSSW_7_4_12_patch4/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/BSUB/ggH125a9_GenTauDecayID_IndividualCJ_minFilterObj0_FEB25/ggH125a9_GenTauDecayID_IndividualCJ_minFilterObj0_FEB25_Plots.root'),
