...
process.ggh = cms.EDAnalyzer("GGHAnalyzer",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/NMSSM_Analysis/CMSSW_7_4_12_patch4/src/BBA/Analyzer/BSUB/BBATauReco_a30_fixed_DEC_10/BBATauReco_a30_fixed_DEC_10.root'),
