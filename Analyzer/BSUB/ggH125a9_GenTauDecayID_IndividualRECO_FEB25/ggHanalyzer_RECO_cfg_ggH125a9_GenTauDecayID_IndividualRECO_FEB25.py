...
process.ggh = cms.EDAnalyzer("GGHAnalyzer_IndivRECO",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/GroupDir/CMSSW_7_4_12_patch4/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/BSUB/ggH125a9_GenTauDecayID_IndividualRECO_FEB25/ggH125a9_GenTauDecayID_IndividualRECO_FEB25_Plots.root'),
