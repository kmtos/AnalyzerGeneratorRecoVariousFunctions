...
process.ggh = cms.EDAnalyzer("TauRecoAnalyzer",
   outFileName = cms.string('/afs/cern.ch/user/k/ktos/NMSSM_Analysis/CMSSW_7_4_12_patch4/src/BBA/Analyzer/BSUB/ttbarTauReco_noGen_DEC_11/ttbarTauReco_noGen_DEC_11.root'),
