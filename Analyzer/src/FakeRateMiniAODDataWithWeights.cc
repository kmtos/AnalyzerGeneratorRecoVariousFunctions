// -*- C++ -*-
//
// Package:    FakeRateMiniAODDataWithWeights
// Class:      FakeRateMiniAODDataWithWeights
// 
/**\class FakeRateMiniAODDataWithWeights FakeRateMiniAODDataWithWeights.cc Analyzer/src/FakeRateMiniAODDataWithWeights.cc
...
class FakeRateMiniAODDataWithWeights : public edm::EDAnalyzer {
   public:
      typedef reco::JetFloatAssociation::Container JetBCEnergyRatioCollection;
      explicit FakeRateMiniAODDataWithWeights(const edm::ParameterSet&);
      ~FakeRateMiniAODDataWithWeights();
...
//
FakeRateMiniAODDataWithWeights::FakeRateMiniAODDataWithWeights(const edm::ParameterSet& iConfig):
...
FakeRateMiniAODDataWithWeights::~FakeRateMiniAODDataWithWeights()
{
  reset(true);
}
...
void FakeRateMiniAODDataWithWeights::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
//        VTightIso = iTau->tauID(vTightIsoTag_);
  ...
  PtMu1FakeWeight_->Fill(mu1.pt(), weight);
  PtMu2FakeWeight_->Fill(mu2.pt(), weight);
  EtaFakeWeight_->Fill(mu1.eta(), weight);
  double dR_Mu1Mu2 = deltaR(mu1, mu2);
  DRFakeWeight_->Fill(dR_Mu1Mu2, weight);
  DRNoWeighting_->Fill(dR_Mu1Mu2);
}//End FakeRateMiniAODDataWithWeights::analyze


// ------------ method called once each job just before starting event loop  ------------
void FakeRateMiniAODDataWithWeights::beginJob()
{
...
void FakeRateMiniAODDataWithWeights::endJob()
{
  //Make the Canvases
...
void FakeRateMiniAODDataWithWeights::beginRun(edm::Run const&, edm::EventSetup const&) {}

// ------------ method called when ending the processing of a run  ------------
void FakeRateMiniAODDataWithWeights::endRun(edm::Run const&, edm::EventSetup const&) {}

// ------------ method called when starting to processes a luminosity block  ------------
void FakeRateMiniAODDataWithWeights::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&) {}

// ------------ method called when ending the processing of a luminosity block  ------------
void FakeRateMiniAODDataWithWeights::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&) {}

//Delete Memory
void FakeRateMiniAODDataWithWeights::reset(const bool doDelete)
{
...
void FakeRateMiniAODDataWithWeights::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(FakeRateMiniAODDataWithWeights);
