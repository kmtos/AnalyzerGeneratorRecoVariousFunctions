...
class GGHAnalyzer_OLD : public edm::EDAnalyzer {
   ...
   private:
      ...
      TMultiGraph* FinalEffLooseIsoSAMEPtMVA_;
      TMultiGraph* FinalEffMedIsoSAMEPtMVA_;
      TMultiGraph* FinalEffTightIsoSAMEPtMVA_;
      TMultiGraph* FinalEffLooseIsoSAMEdRMVA_;
      TMultiGraph* FinalEffMedIsoSAMEdRMVA_;
      TMultiGraph* FinalEffTightIsoSAMEdRMVA_;
      TMultiGraph* FinalEffLooseIsoSAMEPtGenMVA_;
      TMultiGraph* FinalEffMedIsoSAMEPtGenMVA_;
      TMultiGraph* FinalEffTightIsoSAMEPtGenMVA_;
...
/////////////////////// 
  ...
  unsigned int MedIsoCJMVA1 = 0, MedIsoCJMVA2 = 0, LooseIsoCJMVA1 = 0, LooseIsoCJMVA2 = 0, TightIsoCJMVA1 = 0, TightIsoCJMVA2 = 0;
  ...
  for (std::vector<reco::PFTau>::const_iterator iTauCJ = pTausCJ->begin(); iTauCJ != pTausCJ->end(); ++iTauCJ)
  {
    ...
    if (dR_GenMatchCJTEMP1 < .4 && dR_GenMatchCJTEMP1 < dR_GenMatchCJ1 && checkGenMuHad == 1) // && (dR_GenMatchCJTEMP1 < dR_GenMatchCJTEMP2 || dR_GenMatchCJTEMP2 > dR_GenMatchCJ2) )
    {
      ...
      MedIsoCJMVA1 = (*pMedIsoDiscCJMVA)[PFTauRef];
      LooseIsoCJMVA1 = (*pLooseIsoDiscCJMVA)[PFTauRef];
      TightIsoCJMVA1 = (*pTightIsoDiscCJMVA)[PFTauRef];
  ...
  if (dR_GenMatchCJ2 != 1000 && checkGenMuHad == 2)
  {
    ...
    MatchedCJPtMVA_->Fill(Pt_GenMatchCJ2 );
    if (TightIsoCJMVA2 == 1)
      MatchedTightIsoCJPtMVA_->Fill(Pt_GenMatchCJ2 );
    if (MedIsoCJMVA2 == 1)
      MatchedMedIsoCJPtMVA_->Fill(Pt_GenMatchCJ2 );
    if (LooseIsoCJMVA2 == 1)
      MatchedLooseIsoCJPtMVA_->Fill(Pt_GenMatchCJ2 );
    ...
    MatchedCJdRMVA_->Fill(dR_tauMu_gen );
    if (TightIsoCJMVA2 == 1)
      MatchedTightIsoCJdRMVA_->Fill(dR_tauMu_gen );
    if (MedIsoCJMVA2 == 1)
      MatchedMedIsoCJdRMVA_->Fill(dR_tauMu_gen );
    if (LooseIsoCJMVA2 == 1)
      MatchedLooseIsoCJdRMVA_->Fill(dR_tauMu_gen );
    ...
    MatchedCJPtGenMVA_->Fill(GenTau2Visible.Pt() );
    if (TightIsoCJMVA2 == 1)
      MatchedTightIsoCJPtGenMVA_->Fill(GenTau2Visible.Pt() );
    if (MedIsoCJMVA2 == 1)
      MatchedMedIsoCJPtGenMVA_->Fill(GenTau2Visible.Pt() );
    if (LooseIsoCJMVA2 == 1)
      MatchedLooseIsoCJPtGenMVA_->Fill(GenTau2Visible.Pt() );
  ...
  else if (dR_GenMatchCJ1 != 1000 && checkGenMuHad == 1)
  {
    ...
    MatchedCJPtMVA_->Fill(Pt_GenMatchCJ1 );
    if (TightIsoCJMVA1 == 1)
      MatchedTightIsoCJPtMVA_->Fill(Pt_GenMatchCJ1 );
    if (MedIsoCJMVA1 == 1)
      MatchedMedIsoCJPtMVA_->Fill(Pt_GenMatchCJ1 );
    if (LooseIsoCJMVA1 == 1)
      MatchedLooseIsoCJPtMVA_->Fill(Pt_GenMatchCJ1 );
    ...
    MatchedCJPtGenMVA_->Fill(GenTau1Visible.Pt() );
    if (TightIsoCJMVA1 == 1)
      MatchedTightIsoCJPtGenMVA_->Fill(GenTau1Visible.Pt() );
    if (MedIsoCJMVA1 == 1)
      MatchedMedIsoCJPtGenMVA_->Fill(GenTau1Visible.Pt() );
    if (LooseIsoCJMVA1 == 1)
      MatchedLooseIsoCJPtGenMVA_->Fill(GenTau1Visible.Pt() );
...
//////////////////////////
  ...
  unsigned int MedIsoRECOMVA1 = 0, MedIsoRECOMVA2 = 0, LooseIsoRECOMVA1 = 0, LooseIsoRECOMVA2 = 0, TightIsoRECOMVA1 = 0, TightIsoRECOMVA2 = 0;
  for (std::vector<reco::PFTau>::const_iterator iTauRECO = pTausRECO->begin(); iTauRECO != pTausRECO->end(); ++iTauRECO)
  {
    ...
    if (dR_GenMatchRECOTEMP1 < .4 && dR_GenMatchRECOTEMP1 < dR_GenMatchRECO1 && checkGenMuHad == 1) //&& (dR_GenMatchRECOTEMP1 < dR_GenMatchRECOTEMP2 || dR_GenMatchRECOTEMP2 > dR_GenMatchRECO2) )
    {
      ...
      MedIsoRECOMVA1 = (*pMedIsoDiscRECOMVA)[PFTauRef];
      LooseIsoRECOMVA1 = (*pLooseIsoDiscRECOMVA)[PFTauRef];
      TightIsoRECOMVA1 = (*pTightIsoDiscRECOMVA)[PFTauRef];
    ...
    else if (dR_GenMatchRECOTEMP2 < .4 && dR_GenMatchRECOTEMP2 < dR_GenMatchRECO2 && checkGenMuHad == 2) // && (dR_GenMatchRECOTEMP2 < dR_GenMatchRECOTEMP1 || dR_GenMatchRECOTEMP1 > dR_GenMatchRECO1) )
    {
      ...
      MedIsoRECOMVA2 = (*pMedIsoDiscRECOMVA)[PFTauRef];
      LooseIsoRECOMVA2 = (*pLooseIsoDiscRECOMVA)[PFTauRef]; 
      TightIsoRECOMVA2 = (*pTightIsoDiscRECOMVA)[PFTauRef];
    }//else
  ...
  if (dR_GenMatchRECO2 != 1000 && checkGenMuHad == 2)
  {
    ...
    MatchedRECOPtMVA_->Fill(Pt_GenMatchRECO2 );
    if (TightIsoRECOMVA2 == 1)
      MatchedTightIsoRECOPtMVA_->Fill(Pt_GenMatchRECO2 );
    if (MedIsoRECOMVA2 == 1)
      MatchedMedIsoRECOPtMVA_->Fill(Pt_GenMatchRECO2 );
    if (LooseIsoRECOMVA2 == 1)
      MatchedLooseIsoRECOPtMVA_->Fill(Pt_GenMatchRECO2 );
    ...
    MatchedRECOdRMVA_->Fill(dR_tauMu_gen );
    if (TightIsoRECOMVA2 == 1)
      MatchedTightIsoRECOdRMVA_->Fill(dR_tauMu_gen );
    if (MedIsoRECOMVA2 == 1)
      MatchedMedIsoRECOdRMVA_->Fill(dR_tauMu_gen );
    if (LooseIsoRECOMVA2 == 1)
      MatchedLooseIsoRECOdRMVA_->Fill(dR_tauMu_gen );
    ...
    MatchedRECOPtGenMVA_->Fill(GenTau2Visible.Pt() );
    if (TightIsoRECOMVA2 == 1)
      MatchedTightIsoRECOPtGenMVA_->Fill(GenTau2Visible.Pt() );
    if (MedIsoRECOMVA2 == 1)
      MatchedMedIsoRECOPtGenMVA_->Fill(GenTau2Visible.Pt() );
    if (LooseIsoRECOMVA2 == 1)
      MatchedLooseIsoRECOPtGenMVA_->Fill(GenTau2Visible.Pt() );
  ...
  else if (dR_GenMatchRECO1 != 1000 && checkGenMuHad == 1)
  {
   ...
   MatchedRECOPtMVA_->Fill(Pt_GenMatchRECO1 );
   if (TightIsoRECOMVA1 == 1)
     MatchedTightIsoRECOPtMVA_->Fill(Pt_GenMatchRECO1 );
   if (MedIsoRECOMVA1 == 1)
     MatchedMedIsoRECOPtMVA_->Fill(Pt_GenMatchRECO1 );
   if (LooseIsoRECOMVA1 == 1)
     MatchedLooseIsoRECOPtMVA_->Fill(Pt_GenMatchRECO1 );
   ...
   MatchedRECOPtGenMVA_->Fill(GenTau1Visible.Pt() );
   if (TightIsoRECOMVA1 == 1)
     MatchedTightIsoRECOPtGenMVA_->Fill(GenTau1Visible.Pt() );
   if (MedIsoRECOMVA1 == 1)
     MatchedMedIsoRECOPtGenMVA_->Fill(GenTau1Visible.Pt() );
   if (LooseIsoRECOMVA1 == 1)
     MatchedLooseIsoRECOPtGenMVA_->Fill(GenTau1Visible.Pt() );
...
void GGHAnalyzer_OLD::beginJob()
{
  ...
  TauHadnConstvsPt_  = new TH2F("TauHadnConstvsPt" , "", 50, 0, 50, 30, 0, 150);
  RECOPtvsGENVisiblePtCJ_  = new TH2F("RECOPtvsGENVisiblePtCJ" , "", 50, 0, 150, 50, 0, 150);
  RECOPtvsGENVisiblePtRECO_  = new TH2F("RECOPtvsGENVisiblePtRECO" , "", 50, 0, 150, 50, 0, 150);
  ...
  MatchedLooseIsoRECOPtMVA_  = new TH1F("MatchedLooseIsoRECOPtMVA"    , "", 10, 0, 150.0);
  MatchedMedIsoRECOPtMVA_    = new TH1F("MatchedMedIsoRECOPtMVA", "", 10, 0, 150);
  MatchedTightIsoRECOPtMVA_    = new TH1F("MatchedTightIsoRECOPtMVA", "", 10, 0, 150);
  MatchedRECOPtMVA_          = new TH1F("MatchedRECOPtMVA"    , "", 10, 0, 150);
  ...
  MatchedLooseIsoCJPtMVA_  = new TH1F("MatchedLooseIsoCJPtMVA"    , "", 10, 0, 150.0);
  MatchedMedIsoCJPtMVA_    = new TH1F("MatchedMedIsoCJPtMVA", "", 10, 0, 150);
  MatchedTightIsoCJPtMVA_    = new TH1F("MatchedTightIsoCJPtMVA", "", 10, 0, 150);
  MatchedCJPtMVA_          = new TH1F("MatchedCJPtMVA"    , "", 10, 0, 150);
  ...
  MatchedLooseIsoRECOdRMVA_  = new TH1F("MatchedLooseIsoRECOdRMVA"    , "", 10, 0, 1.5);
  MatchedMedIsoRECOdRMVA_    = new TH1F("MatchedMedIsoRECOdRMVA", "", 10, 0, 1.5);
  MatchedTightIsoRECOdRMVA_    = new TH1F("MatchedTightIsoRECOdRMVA", "", 10, 0, 1.5);
  MatchedRECOdRMVA_          = new TH1F("MatchedRECOdRMVA"    , "", 10, 0, 1.5);
  ...
  MatchedLooseIsoCJdRMVA_  = new TH1F("MatchedLooseIsoCJdRMVA"    , "", 10, 0, 1.5);
  MatchedMedIsoCJdRMVA_    = new TH1F("MatchedMedIsoCJdRMVA", "", 10, 0, 1.5);
  MatchedTightIsoCJdRMVA_    = new TH1F("MatchedTightIsoCJdRMVA", "", 10, 0, 1.5);
  MatchedCJdRMVA_          = new TH1F("MatchedCJdRMVA"    , "", 10, 0, 1.5);
  ...
  MatchedLooseIsoRECOPtGenMVA_  = new TH1F("MatchedLooseIsoRECOPtGenMVA"    , "", 10, 0, 150.0);
  MatchedMedIsoRECOPtGenMVA_    = new TH1F("MatchedMedIsoRECOPtGenMVA", "", 10, 0, 150);
  MatchedTightIsoRECOPtGenMVA_    = new TH1F("MatchedTightIsoRECOPtGenMVA", "", 10, 0, 150);
  MatchedRECOPtGenMVA_          = new TH1F("MatchedRECOPtGenMVA"    , "", 10, 0, 150);
  ...
  MatchedLooseIsoCJPtGenMVA_  = new TH1F("MatchedLooseIsoCJPtGenMVA"    , "", 10, 0, 150.0);
  MatchedMedIsoCJPtGenMVA_    = new TH1F("MatchedMedIsoCJPtGenMVA", "", 10, 0, 150);
  MatchedTightIsoCJPtGenMVA_    = new TH1F("MatchedTightIsoCJPtGenMVA", "", 10, 0, 150);
  MatchedCJPtGenMVA_          = new TH1F("MatchedCJPtGenMVA"    , "", 10, 0, 150);
  ...
  FinalEffLooseIsoSAMEPtMVA_ = new TMultiGraph();
  FinalEffMedIsoSAMEPtMVA_ = new TMultiGraph();
  FinalEffTightIsoSAMEPtMVA_ = new TMultiGraph();
  FinalEffLooseIsoSAMEdRMVA_ = new TMultiGraph();
  FinalEffMedIsoSAMEdRMVA_ = new TMultiGraph();
  FinalEffTightIsoSAMEdRMVA_ = new TMultiGraph();
  FinalEffLooseIsoSAMEPtGenMVA_ = new TMultiGraph();
  FinalEffMedIsoSAMEPtGenMVA_ = new TMultiGraph();
  FinalEffTightIsoSAMEPtGenMVA_ = new TMultiGraph();
...
void GGHAnalyzer_OLD::endJob()
{
  ...
  TCanvas FinalEffLooseIsoSAMEPtMVACanvas("FinalEffLooseIsoSAMEPtMVA","",600,600);
  TCanvas FinalEffMedIsoSAMEPtMVACanvas("FinalEffMedIsoSAMEPtMVA","",600,600);
  TCanvas FinalEffTightIsoSAMEPtMVACanvas("FinalEffTightIsoSAMEPtMVA","",600,600);
  TCanvas FinalEffLooseIsoSAMEdRMVACanvas("FinalEffLooseIsoSAMEdRMVA","",600,600);
  TCanvas FinalEffMedIsoSAMEdRMVACanvas("FinalEffMedIsoSAMEdRMVA","",600,600);
  TCanvas FinalEffTightIsoSAMEdRMVACanvas("FinalEffTightIsoSAMEdRMVA","",600,600);
  TCanvas FinalEffLooseIsoSAMEPtGenMVACanvas("FinalEffLooseIsoSAMEPtGenMVA","",600,600);
  TCanvas FinalEffMedIsoSAMEPtGenMVACanvas("FinalEffMedIsoSAMEPtGenMVA","",600,600);
  TCanvas FinalEffTightIsoSAMEPtGenMVACanvas("FinalEffTightIsoSAMEPtGenMVA","",600,600);
...
std::cout << "<----------------Declared Canvases-------------->" << std::endl;
  ...
  VariousFunctions::formatAndDrawCanvasAndHist1D(MatchedLooseIsoRECOPtMVACanvas, MatchedLooseIsoRECOPtMVA_,
         1, 0, 0, kBlack, 7, 20, "PtMVA(RECO Matched + Loose Iso + DM)", .04, .04, 1.1,  "", .04, .04, 1.0, false);
  VariousFunctions::formatAndDrawCanvasAndHist1D(MatchedMedIsoRECOPtMVACanvas, MatchedMedIsoRECOPtMVA_,
         1, 0, 0, kBlack, 7, 20, "PtMVA(RECO Matched + Med Iso + DM)", .04, .04, 1.1,  "", .04, .04, 1.0, false);
  VariousFunctions::formatAndDrawCanvasAndHist1D(MatchedTightIsoRECOPtMVACanvas, MatchedTightIsoRECOPtMVA_,
         1, 0, 0, kBlack, 7, 20, "PtMVA(RECO Matched + Tight Iso + DM)", .04, .04, 1.1,  "", .04, .04, 1.0, false);
 ...
 VariousFunctions::formatAndDrawCanvasAndTGraphAsym(FinalEffLooseIsoRECOPtMVACanvas, FinalEffLooseIsoRECOPtMVA_,
        1, 0, 0, kBlack, 1, 20, "PtMVA(RECO Matched + Loose Iso + DM) / PtMVA(RECO Matched)", .04, .04, 1.1,  "#epsilon", .04, .04, 1.0, false);
 VariousFunctions::formatAndDrawCanvasAndTGraphAsym(FinalEffMedIsoRECOPtMVACanvas, FinalEffMedIsoRECOPtMVA_,
        1, 0, 0, kBlack, 1, 20, "PtMVA(RECO Matched + Med Iso + DM) / PtMVA(RECO Matched)", .04, .04, 1.1,  "#epsilon", .04, .04, 1.0, false);
 VariousFunctions::formatAndDrawCanvasAndTGraphAsym(FinalEffTightIsoRECOPtMVACanvas, FinalEffTightIsoRECOPtMVA_,
        1, 0, 0, kBlack, 1, 20, "PtMVA(RECO Matched + Tight Iso + DM) / PtMVA(RECO Matched)", .04, .04, 1.1,  "#epsilon", .04, .04, 1.0, false);
  ...
  VariousFunctions::formatAndDrawCanvasAndHist1D(MatchedLooseIsoRECOPtGenMVACanvas, MatchedLooseIsoRECOPtGenMVA_,
         1, 0, 0, kBlack, 7, 20, "PtGenMVA(RECO Matched + Loose Iso + DM)", .04, .04, 1.1,  "", .04, .04, 1.0, false);
  VariousFunctions::formatAndDrawCanvasAndHist1D(MatchedMedIsoRECOPtGenMVACanvas, MatchedMedIsoRECOPtGenMVA_,
         1, 0, 0, kBlack, 7, 20, "PtGenMVA(RECO Matched + Med Iso + DM)", .04, .04, 1.1,  "", .04, .04, 1.0, false);
  VariousFunctions::formatAndDrawCanvasAndHist1D(MatchedTightIsoRECOPtGenMVACanvas, MatchedTightIsoRECOPtGenMVA_,
         1, 0, 0, kBlack, 7, 20, "PtGenMVA(RECO Matched + Tight Iso + DM)", .04, .04, 1.1,  "", .04, .04, 1.0, false);
  ...
  VariousFunctions::formatAndDrawCanvasAndTGraphAsym(FinalEffLooseIsoRECOPtGenMVACanvas, FinalEffLooseIsoRECOPtGenMVA_,
         1, 0, 0, kBlack, 1, 20, "PtGenMVA(RECO Matched + Loose Iso + DM) / PtGenMVA(RECO Matched)", .04, .04, 1.1,  "#epsilon", .04, .04, 1.0, false);
  VariousFunctions::formatAndDrawCanvasAndTGraphAsym(FinalEffMedIsoRECOPtGenMVACanvas, FinalEffMedIsoRECOPtGenMVA_,
         1, 0, 0, kBlack, 1, 20, "PtGenMVA(RECO Matched + Med Iso + DM) / PtGenMVA(RECO Matched)", .04, .04, 1.1,  "#epsilon", .04, .04, 1.0, false);
  VariousFunctions::formatAndDrawCanvasAndTGraphAsym(FinalEffTightIsoRECOPtGenMVACanvas, FinalEffTightIsoRECOPtGenMVA_,
         1, 0, 0, kBlack, 1, 20, "PtGenMVA(RECO Matched + Tight Iso + DM) / PtGenMVA(RECO Matched)", .04, .04, 1.1,  "#epsilon", .04, .04, 1.0, false);
...
std::cout << "after formatting" << std::endl;
  ...
  FinalEffLooseIsoSAMEPtMVACanvas.cd();
  FinalEffLooseIsoSAMEPtMVA_->Add(FinalEffLooseIsoCJPtMVA_);
  FinalEffLooseIsoSAMEPtMVA_->Add(FinalEffLooseIsoRECOPtMVA_);
  FinalEffLooseIsoSAMEPtMVA_->Draw("ap");
  FinalEffLooseIsoSAMEPtMVA_->GetXaxis()->SetTitle("p_{T}");
  FinalEffLooseIsoSAMEPtMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Loose Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffMedIsoSAMEPtMVACanvas.cd();
  FinalEffMedIsoSAMEPtMVA_->Add(FinalEffMedIsoCJPtMVA_);
  FinalEffMedIsoSAMEPtMVA_->Add(FinalEffMedIsoRECOPtMVA_);
  FinalEffMedIsoSAMEPtMVA_->Draw("ap");
  FinalEffMedIsoSAMEPtMVA_->GetXaxis()->SetTitle("p_{T}");
  FinalEffMedIsoSAMEPtMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Med Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffTightIsoSAMEPtMVACanvas.cd();
  FinalEffTightIsoSAMEPtMVA_->Add(FinalEffTightIsoCJPtMVA_);
  FinalEffTightIsoSAMEPtMVA_->Add(FinalEffTightIsoRECOPtMVA_);
  FinalEffTightIsoSAMEPtMVA_->Draw("ap");
  FinalEffTightIsoSAMEPtMVA_->GetXaxis()->SetTitle("p_{T}");
  FinalEffTightIsoSAMEPtMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Tight  Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffLooseIsoSAMEdR_->GetXaxis()->SetTitle("#DeltaR (#tau#tua)");
  FinalEffLooseIsoSAMEdR_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Loose Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  
  FinalEffLooseIsoSAMEdRMVACanvas.cd();
  FinalEffLooseIsoSAMEdRMVA_->Add(FinalEffLooseIsoCJdRMVA_);
  FinalEffLooseIsoSAMEdRMVA_->Add(FinalEffLooseIsoRECOdRMVA_);
  FinalEffLooseIsoSAMEdRMVA_->Draw("ap");
  FinalEffLooseIsoSAMEdRMVA_->GetXaxis()->SetTitle("#DeltaR (#tau#tua)");
  FinalEffLooseIsoSAMEdRMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Loose Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffMedIsoSAMEdRMVACanvas.cd();
  FinalEffMedIsoSAMEdRMVA_->Add(FinalEffMedIsoCJdRMVA_);
  FinalEffMedIsoSAMEdRMVA_->Add(FinalEffMedIsoRECOdRMVA_);
  FinalEffMedIsoSAMEdRMVA_->Draw("ap");
  FinalEffMedIsoSAMEdRMVA_->GetXaxis()->SetTitle("#DeltaR (#tau#tua)");
  FinalEffMedIsoSAMEdRMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Med Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffTightIsoSAMEdRMVACanvas.cd();
  FinalEffTightIsoSAMEdRMVA_->Add(FinalEffTightIsoCJdRMVA_);
  FinalEffTightIsoSAMEdRMVA_->Add(FinalEffTightIsoRECOdRMVA_);
  FinalEffTightIsoSAMEdRMVA_->Draw("ap");
  FinalEffTightIsoSAMEdRMVA_->GetXaxis()->SetTitle("#DeltaR (#tau#tua)");
  FinalEffTightIsoSAMEdRMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Tight Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffDMFindSAMEdR_->GetXaxis()->SetTitle("#DeltaR (#tau#tua)");
  ...
  FinalEffLooseIsoSAMEPtGenMVACanvas.cd();
  FinalEffLooseIsoSAMEPtGenMVA_->Add(FinalEffLooseIsoCJPtGenMVA_);
  FinalEffLooseIsoSAMEPtGenMVA_->Add(FinalEffLooseIsoRECOPtGenMVA_);
  FinalEffLooseIsoSAMEPtGenMVA_->Draw("ap");
  FinalEffLooseIsoSAMEPtGenMVA_->GetXaxis()->SetTitle("p_{T} Gen-Visible");
  FinalEffLooseIsoSAMEPtGenMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Loose Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffMedIsoSAMEPtGenMVACanvas.cd();
  FinalEffMedIsoSAMEPtGenMVA_->Add(FinalEffMedIsoCJPtGenMVA_);
  FinalEffMedIsoSAMEPtGenMVA_->Add(FinalEffMedIsoRECOPtGenMVA_);
  FinalEffMedIsoSAMEPtGenMVA_->Draw("ap");
  FinalEffMedIsoSAMEPtGenMVA_->GetXaxis()->SetTitle("p_{T} Gen-Visible");
  FinalEffMedIsoSAMEPtGenMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Med Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
  ...
  FinalEffTightIsoSAMEPtGenMVACanvas.cd();
  FinalEffTightIsoSAMEPtGenMVA_->Add(FinalEffTightIsoCJPtGenMVA_);
  FinalEffTightIsoSAMEPtGenMVA_->Add(FinalEffTightIsoRECOPtGenMVA_);
  FinalEffTightIsoSAMEPtGenMVA_->Draw("ap");
  FinalEffTightIsoSAMEPtGenMVA_->GetXaxis()->SetTitle("p_{T} Gen-Visible");
  FinalEffTightIsoSAMEPtGenMVA_->GetYaxis()->SetTitle("#epsilon (Matched + DM + Tight Isolation / Matched)");
  gPad->Modified();
  leg->Draw();
...
std::cout << "<----------------Formatted Canvases and Histos-------------->" << std::endl;
  ...
  FinalEffLooseIsoSAMEPtMVACanvas.Write();
  FinalEffMedIsoSAMEPtMVACanvas.Write();
  FinalEffTightIsoSAMEPtMVACanvas.Write();
  FinalEffLooseIsoSAMEdRMVACanvas.Write();
  FinalEffMedIsoSAMEdRMVACanvas.Write();
  FinalEffTightIsoSAMEdRMVACanvas.Write();
  FinalEffLooseIsoSAMEPtGenMVACanvas.Write();
  FinalEffMedIsoSAMEPtGenMVACanvas.Write();
  FinalEffTightIsoSAMEPtGenMVACanvas.Write();
