...
process.ggh = cms.EDAnalyzer("FakeRateMiniAODGetRates",
   ...
   checkInvMassMin = cms.double(60),
   checkInvMassMax = cms.double(120),
   ...
   PileupFileName = cms.string('/afs/cern.ch/work/k/ktos/public/CMSSW_8_0_17/src/AnalyzerGeneratorRecoVariousFunctions/Analyzer/FILE_TESTS/pileup_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6.root'),
