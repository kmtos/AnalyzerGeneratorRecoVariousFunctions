...
process.maxEvents = cms.untracked.PSet(
        input = cms.untracked.int32(1000) #Changed from 2141 to 300 since thats what was in SignalSampleGenerator.py
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('../Configuration/GenProduction/python/HIG-RunIIFall14GS-00006-fragment.py nevts:300'), #Changed nevts from 2141 to 300
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('NMSSM_a9_Wh1_JOBNUM.root'),
...
#process.muelegenfilter = cms.EDFilter("MCSmartSingleParticleFilter",
#    MaxDecayRadius = cms.untracked.vdouble(2000.0, 2000.0, 2000.0, 2000.0),
#    Status = cms.untracked.vint32(1, 1, 1, 1),
#    MinPt = cms.untracked.vdouble(15.0, 15.0, 15.0, 15.0),
