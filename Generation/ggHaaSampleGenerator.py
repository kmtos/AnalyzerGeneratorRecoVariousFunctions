...
process.maxEvents = cms.untracked.PSet(
        input = cms.untracked.int32(500) #Changed from 2141 to 300 since thats what was in SignalSampleGenerator.py
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('DIRNAME_JOBNUM.root'),
